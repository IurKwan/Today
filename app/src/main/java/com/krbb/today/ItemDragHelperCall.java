...
/**
 * Created by rui on 2018/2/5 21:24
 * Email：guanzhirui@outlook.com
 */


public class ItemDragHelperCall extends ItemTouchHelper.Callback{
    private OnChannelListener onChannelListener;

    public ItemDragHelperCall(OnChannelListener onChannelDragListener) {
