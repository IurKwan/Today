...
/**
 * Created by rui on 2018/2/5 21:14
...
public class NewAdapter extends BaseMultiItemQuickAdapter<Channel, BaseViewHolder> {
    ...
    public NewAdapter(List<Channel> data, ItemTouchHelper helper) {
        ...
        addItemType(Channel.TYPE_MY, R.layout.item_my_channel_header);
        addItemType(Channel.TYPE_MY_CHANNEL, R.layout.item_my);
        addItemType(Channel.TYPE_OTHER, R.layout.item_my_channel_header);
        addItemType(Channel.TYPE_OTHER_CHANNEL, R.layout.item_my);
    }
                    ...
                    public void onClick(View v) {
                        if (!mIsEdit) {
                            ...
                            if (onChannelListener != null){
                                onChannelListener.onEditing(true);
                            }
                        } else {
                            startEditMode(false);
                            if (onChannelListener != null){
                                onChannelListener.onEditing(false);
                            }
                        }
                    }
                });
